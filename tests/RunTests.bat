...
:: Check
if not exist "%packagerExe%" echo Error - Missing or unreachable "%packagerExe%" && echo Please first compile an exe using pyinstaller && compiling script at: %~dp0..\pyinstaller\Compile_Exe.bat && puase && exit 1
